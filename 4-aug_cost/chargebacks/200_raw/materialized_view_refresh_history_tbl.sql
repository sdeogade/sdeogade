...
--
create transient table if not exists &{l_raw_db}.&{l_raw_schema}.materialized_view_refresh_history_stg
(
...
--
create table if not exists &{l_raw_db}.&{l_raw_schema}.materialized_view_refresh_history
(
