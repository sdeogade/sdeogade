...
--
create transient table if not exists &{l_raw_db}.&{l_raw_schema}.search_optimization_history_stg
(
...
--
create table if not exists &{l_raw_db}.&{l_raw_schema}.search_optimization_history
(
