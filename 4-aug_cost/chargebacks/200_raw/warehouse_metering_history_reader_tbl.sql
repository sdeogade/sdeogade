...
--
create transient table if not exists &{l_raw_db}.&{l_raw_schema}.warehouse_metering_history_reader_stg
(
...
--
create table if not exists &{l_raw_db}.&{l_raw_schema}.warehouse_metering_history_reader
(
