...
begin;
    ...
    --
    delete from
        &{l_il_db}.&{l_il_schema}.cb_resource_consumption_ds
    where
            event_dt >= $l_start_dt
    ...
    (
        ...
        select
            ...
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, wmh.start_time ) )    as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, ach.start_time ) )    as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, mvrh.start_time ) )    as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, puh.start_time ) )    as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, soh.start_time ) )    as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, ruh.start_time ) )    as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, dsuh.usage_date ) )     as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, ssuh.usage_date ) )     as dw_event_date_sid
        ...
        select
            ...
            ,csh.dw_resource_shk
            ,cstl.dw_service_type_shk
            ,&{l_common_db}.&{l_common_schema}.date_sid_f( date_trunc( day, dth.start_time ) )        as dw_event_date_sid
    ...
    select
        ...
        ,lrc.compute_credit_cnt * &{l_common_db}.&{l_common_schema}.sf_compute_cost_f( lrc.dw_account_shk, lrc.event_dt )
                                                                as compute_cost_amt
        ,lrc.storage_byte_cnt
        ,lrc.storage_byte_cnt / pow( 1024, 4 )                  as storage_tb_cnt
        ,(lrc.storage_byte_cnt / pow( 1024, 4 )) * &{l_common_db}.&{l_common_schema}.sf_storage_cost_f( lrc.dw_account_shk, lrc.event_dt )
                                                                as storage_cost_amt
        ,lrc.data_xfer_byte_cnt
        ,lrc.data_xfer_byte_cnt / pow( 1024, 4 )                as data_xfer_tb_cnt
        ,(lrc.data_xfer_byte_cnt / pow( 1024, 4 )) * &{l_common_db}.&{l_common_schema}.sf_data_xfer_cost_f( lrc.dw_account_shk, lrc.event_dt )
    ...
    where
        not exists
        (
            select 1 from &{l_il_db}.&{l_il_schema}.cb_resource_consumption_ds where event_dt >= $l_start_dt and event_dt < $l_end_dt
        )
    order by
        3
    ;
